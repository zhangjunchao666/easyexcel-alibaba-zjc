...
public class WriteTest {
    ...
    public void writeV2007() throws IOException {
        ...
        OutputStream out = new FileOutputStream(com.getPath()+"\\2007.xlsx");
        ExcelWriter writer = EasyExcelFactory.getWriter(out);
        //写第一个sheet, sheet1  数据全是List<String> 无模型映射关系
        Sheet sheet1 = new Sheet(1, 3);
        sheet1.setSheetName("张俊超sheet");
        ...
        columnWidth.put(3,2500);
        columnWidth.put(4,2500);
        columnWidth.put(5,7800);
        columnWidth.put(6,2500);
        columnWidth.put(7,2000);
